...
if __name__ == "__main__":
    alignments = ["pax6_family.linsi.fasta.trimal",  "pax6_family.muscle.fasta.trimal",  "pax6_family.prank.fasta.best.fas.trimal"]
    print("TrimAL")
    for f in alignments:
        print(alignment_stats(f, label=f))
    alignments = ["pax6_family.linsi.fasta.BMGE",  "pax6_family.muscle.fasta.BMGE",  "pax6_family.prank.fasta.best.fas.BMGE"]
    print("BMGE")
    for f in alignments:
        print(alignment_stats(f, label=f))
